...
export default function ProgramsModule() {
  return (
    <div className="ml-[300px] mt-[38px] flex flex-col bg-[#F4F4F4]">
      ...
      <div className="mt-[48px]">
        ...
        <div className=" mb-4 text-gray-600">Sem 1</div>
      </div>
      ...
      <div className="flex gap-13">
        ...
        <ModuleBox
          ...
          ModuleLeaderName="Yogesh B Shah"
        />

        <ModuleBox
          Image={
            <Image
              src="/imgs/ISA Img.png"
              alt="Illustration"
              fill
              className="object-contain"
              priority
          ...
          ModuleLeaderName="Bishal Khadka"
        />
      </div>

      {/* Sem -2  */}
      <div className="mt-[48px]">
        <div className=" mb-4 text-gray-600">Sem 2</div>
      </div>
      <div className="flex gap-13 mb-10">
        <ModuleBox
          Image={
            <Image
              src="/imgs/Oops.png"
          ...
          ModuleLeaderName="Subash Bista"
        />

        <ModuleBox
          Image={
            <Image
              src="/imgs/Computational Mathematics.png"
              alt="Illustration"
              fill
              className="object-contain"
              priority
