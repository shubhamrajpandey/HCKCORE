...
export default function ModeratorSlideBar() {
  return (
    <aside className="flex flex-col gap-[53px] w-[420px] h-[1036px] bg-black left-0 top-0 rounded-xl ml-4 mt-4 pl-[33px] pr-[65px]">
      ...
      <div className="gap-[28px] flex flex-col">
        <div
          className="flex space-x-3 hover:bg-[#74BF44]
 p-2 rounded-md w-[322px] h-[64px] items-center py-[10px] pl-[11px] cursor-pointer"
        >
          <svg
            width="24"
            height="24"
          ...
          <span className="text-white font-[500]">Dashboard</span>
        </div>
        <div
          className="flex space-x-3 hover:bg-[#74BF44]
 p-2 rounded-md w-[322px] h-[64px] items-center py-[10px] pl-[11px] cursor-pointer"
 ...
 p-2 rounded-md w-[322px] h-[64px] items-center py-[10px] pl-[11px] cursor-pointer"
        >
          ...
          >
            <path
              d="M11.8753 24.7619H2.42105C1.07737 24.7619 0 23.66 0 22.2857V2.47619C0 1.81946 0.255074 1.18964 0.70911 0.725259C1.16315 0.260884 1.77895 0 2.42105 0H12.1053L19.3684 7.42857V13.7305C18.9689 13.6686 18.5695 13.619 18.1579 13.619C17.7463 13.619 17.3468 13.6686 16.9474 13.7305V8.66667H10.8947V2.47619H2.42105V22.2857H11.0037C11.1489 23.1771 11.4516 24.0067 11.8753 24.7619ZM23 19.8095H19.3684V16.0952H16.9474V19.8095H13.3158V22.2857H16.9474V26H19.3684V22.2857H23V19.8095Z"
              fill="white"
            />
          </svg>
