        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#A4C93A]"
            />
            {errors.moduleName && (
          ...
          <div>
            <label className="block text-sm font-medium mb-1">Module Leader</label>
            <input
              type="text"
              placeholder="Eg: John Doe"
              {...register("moduleLeader", { required: "Module leader is required" })}
              className="w-full px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#A4C93A]"
            />
            {errors.moduleLeader && (
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#A4C93A] resize-none"
            ></textarea>
            {errors.description && (
